...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <a class="navbar-brand" href="../screens/dashboard_maestro.php">Dashboard del Maestro</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <span class="navbar-text mr-3">
                Bienvenido, <?php echo $_SESSION['nombreMaestro']; ?>
            </span>
    ...
    <div class="container mt-4">
        ...
        <p>Contenido del dashboard para el Maestro.</p>
    </div>
